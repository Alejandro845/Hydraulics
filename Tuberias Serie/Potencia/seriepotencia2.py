...
nu = 1.141e-06 # Viscosidad cinemática en m^2/s
...
tub1=[-0.0303, 0, 0, 1, 0.254, 393, 0.00015, 12.3]
tub2=[-0.0288, 0, 0, 0, 0.2032, 125, 0.00015, 6.9]
tub3=[-0.0443, 0, 0, 0, 0.1524, 230, 0.00015, 7.8]
...
for tub in sist.values():
    ...
    while True: #Entra para hallar el factor de friccion de la tubería
        ...
        f_new = (-2 * math.log10((tub[6]/ (3.7 * tub[4])) + (2.51 / (Re * math.sqrt(f))))) ** (-2)

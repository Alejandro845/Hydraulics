...
E1 = 26.4 #Energia en el sistema en presión normalmente
E2 = 0 #(m)
...
tub1=[0, 0, 627, 0.2032, 1.5e-06, 10.6]
tub2=[0, 0, 627, 0.3048, 3e-05, 10.6] #Ajustar la cantidad de tuberías según las necesidades del problema
